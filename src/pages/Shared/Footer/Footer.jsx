    ...
    <footer className="my-bg  p-12 pb-6">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="text-gray-900">
          <h3 className="text-gray-900 mb-2">Quick Class Enrollment</h3>
          <p>Register for our upcoming photography classes now!</p>
          <button className="hover:bg-gray-200 bg-white text-gray-900 rounded-full py-1 px-3 mt-3">
            Enroll Now
          </button>
        </div>
        <div className="text-gray-900">
      ...
      <div className="mt-12 md:text-center text-gray-900">
        <p className="text-sm">
